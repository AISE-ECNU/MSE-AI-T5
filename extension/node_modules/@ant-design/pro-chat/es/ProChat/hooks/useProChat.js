...
export var useProChat = function useProChat() {
  ...
  var setChat = useRefFunction(function (id, chat) {
    return dispatchMessage(_objectSpread(_objectSpread({}, chat), {}, {
      type: 'updateMessage',
      id: id,
      value: chat === null || chat === void 0 ? void 0 : chat.content
    }));
  });
  ...
  var getChatById = useRefFunction(function (id) {
    return storeApi.getState().chats.find(function (chat) {
      return chat.id === id;
    });
  });
