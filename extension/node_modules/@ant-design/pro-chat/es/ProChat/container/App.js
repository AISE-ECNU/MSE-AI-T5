...
var useStyles = createStyles(function (_ref) {
  ...
  return css(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n    overflow: hidden scroll;\n    height: 100%;\n    ", " {\n      ", "\n      width: 100%;\n    }\n  "])), responsive === null || responsive === void 0 ? void 0 : responsive.mobile, stylish === null || stylish === void 0 ? void 0 : stylish.noScrollbar);
});
...
var App = /*#__PURE__*/memo(function (_ref2) {
  ...
  var messages = useStore(chatSelectors.currentChats);
  var _useState5 = useState((messages === null || messages === void 0 ? void 0 : messages.length) > 0),
    _useState6 = _slicedToArray(_useState5, 2),
    backBottomVisiable = _useState6[0],
    setBackBottomVisiable = _useState6[1];
  useEffect(function () {
    // 保证 ref 永远存在
    setIsRender(true);
  ...
  useEffect(function () {
    setBackBottomVisiable((messages === null || messages === void 0 ? void 0 : messages.length) > 0);
  }, [messages]);
  var prefixClass = getPrefixCls('pro-chat');
  return /*#__PURE__*/_jsx(RcResizeObserver, {
    onResize: function onResize(e) {
      if (_typeof(height) !== _typeof(e.height) || typeof height === 'string' && typeof e.height === 'string' && e.height !== height) {
        // stop shaking
        setHeight(e.height);
      }
    },
    children: /*#__PURE__*/_jsxs(Flexbox, {
      ...
      children: [/*#__PURE__*/_jsxs(_Fragment, {
        ...
        }), isRender && backBottomVisiable && ref !== null && ref !== void 0 && ref.current ? /*#__PURE__*/_jsx(BackBottom, _objectSpread({
          style: {
            bottom: 138
          },
          onScroll: onScroll,
