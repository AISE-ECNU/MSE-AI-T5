...
export var chatAction = function chatAction(set, get) {
  return {
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _createSmoothMessage = createSmoothMessage(assistantId), startAnimation = _createSmoothMessage.startAnimation, stopAnimation = _createSmoothMessage.stopAnimation, outputQueue = _createSmoothMessage.outputQueue, isAnimationActive = _createSmoothMessage.isAnimationActive, mixRequestResponse = _createSmoothMessage.mixRequestResponse;
              _context6.next = 13;
              return fetchSSE(fetcher, {
                ...
                onFinish: function () {
                  var _onFinish = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(type) {
                ...
                onMessageHandle: function () {
                  var _onMessageHandle = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(text, response) {
                    var _i, _Object$entries, _Object$entries$_i, key, value, TransFormChatMessage;
                    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
                      while (1) switch (_context5.prev = _context5.next) {
                        case 0:
                          output += text;
                          if (response && _typeof(response) === 'object' && 'content' in response) {
                            for (_i = 0, _Object$entries = Object.entries(response); _i < _Object$entries.length; _i++) {
                        ...
                        case 13:
                          _context5.t0 = text;
                        case 14:
                          TransFormChatMessage = _context5.t0;
                          if (onChatGenerate) {
                  ...
                  function onMessageHandle(_x6, _x7) {
    ...
    realFetchAIResponse: function () {
      ...
      function realFetchAIResponse(_x8, _x9) {
    ...
    getMessageId: function () {
      ...
      function getMessageId(_x12, _x13) {
        ...
        return new Promise(function (resolve) {
          ...
          var updateText = function updateText() {
            ...
            if (outputQueue.length > 0) {
              ...
              buffer += charsToAdd;
              if (_typeof(mixRequestResponse) === 'object' && 'content' in mixRequestResponse) {
                dispatchMessage(_objectSpread(_objectSpread({}, mixRequestResponse), {}, {
                  id: id,
                  key: 'content',
                  type: 'updateMessage',
                  value: buffer
