  ...
  var Actions = useRefFunction(function (_ref3) {
    ...
    return {
      click: {
        ...
        onFinishEdit: function onFinishEdit() {
          return setEditing(false);
        },
        onClick: function onClick(actionKey) {
          return handleActionClick === null || handleActionClick === void 0 ? void 0 : handleActionClick(actionKey, data);
        }
      },
      components: /*#__PURE__*/_jsx(RenderFunction, _objectSpread(_objectSpread({}, data), {}, {
        onActionClick: function onActionClick(actionKey) {
          return handleActionClick === null || handleActionClick === void 0 ? void 0 : handleActionClick(actionKey, data);
        },
        text: text,
        actionsProps: chatItemRenderConfig === null || chatItemRenderConfig === void 0 || (_chatItemRenderConfig = chatItemRenderConfig.actionsProps) === null || _chatItemRenderConfig === void 0 ? void 0 : _chatItemRenderConfig[item.role]
      }))
    };
  });
