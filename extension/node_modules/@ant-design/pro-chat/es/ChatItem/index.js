...
var _excluded = ["avatarAddon", "onAvatarClick", "actions", "actionsClick", "className", "primary", "loading", "message", "placement", "type", "avatar", "error", "showTitle", "time", "editing", "onChange", "onEditingChange", "messageExtra", "renderMessage", "text", "chatItemRenderConfig", "renderErrorMessages", "markdownProps", "onDoubleClick", "originData"];
...
var ChatItem = /*#__PURE__*/memo(function (props) {
  ...
  var avatarAddon = props.avatarAddon,
    ...
    actionsClick = props.actionsClick,
  ...
  var actionsDom = useMemo(function () {
    ...
    return (chatItemRenderConfig === null || chatItemRenderConfig === void 0 || (_chatItemRenderConfig3 = chatItemRenderConfig.actionsRender) === null || _chatItemRenderConfig3 === void 0 ? void 0 : _chatItemRenderConfig3.call(chatItemRenderConfig, props, dom, actionsClick)) || dom;
  }, [actions]);
