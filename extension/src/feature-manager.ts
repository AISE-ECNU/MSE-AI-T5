...
const globalReady = new Promise<object>(async (resolve) => {
  ...
  if (pageDetect.is500() || pageDetect.isPasswordConfirmation()) {
    console.log("500 or password confirmation page detected.");
    return;
  }

  if (exists("html.MSE-AI-T5")) {
    console.warn(
      stripIndent(`
      MSE-AI-T5 has been loaded twice. This may be because:
